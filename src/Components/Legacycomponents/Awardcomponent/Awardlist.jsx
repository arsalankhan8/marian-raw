    ...
    <div className='max-w-[90vw] w-full mx-auto '>
        <div className='flex flex-wrap md:flex-nowrap md:gap-10 lg:gap-12 xl:gap-16 2xl:gap-20 pt-[30px]'>            
            <div className='flex flex-col md:gap-2 gap-4 lg:gap-3 xl:gap-4 w-full md:w-[47%]'>
                ...
                <p className='font-unageo-bold text-[16px] md:text-[18px] lg:text-[21px] xl:text-[23px] 3xl:text-[45px] capitalize leading-[100%]'>Ontario Steel Design Award of Excellence – Projects Outside Ontario (2007)</p>
             ...
             <div className='flex flex-col md:gap-2 gap-4 mt-6 md:mt-0 lg:gap-3 xl:gap-4 w-full md:w-[47%]'>
                ...
                <p className='font-unageo-bold text-[16px] md:text-[18px] lg:text-[21px] xl:text-[23px] 3xl:text-[45px] capitalize leading-[100%]'>Ontario Steel Design Award of Excellence – Bridge Category (2019)</p>
            ...
            <div className='flex flex-col md:gap-2 gap-4 lg:gap-3 xl:gap-4 w-full md:w-[47%]'>
                ...
                <p className='font-unageo-bold text-[16px] md:text-[18px] lg:text-[21px] xl:text-[23px] 3xl:text-[45px] capitalize leading-[100%]'>Canadian Consulting Engineering Award of Excellence (2020)</p>
            ...
            <div className='flex flex-col md:gap-2 gap-4 lg:gap-3 xl:gap-4 w-full mt-6 md:mt-0 md:w-[47%]'>
                ...
                <p className='font-unageo-bold text-[16px] md:text-[18px] lg:text-[21px] xl:text-[23px] 3xl:text-[45px] capitalize leading-[100%]'>Top 10 Fabrication Services Providers in Canada (2024)</p>
